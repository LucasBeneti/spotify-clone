  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="w-full flex items-center gap-x-2 text-sm">
        <p aria-label="current song time">
          {getSongDurationInMinutes(currTime)}
        </p>
        <Slider.Root
          value={[trackProgress]}
        ...
        >
          ...
          <Slider.Thumb className="block bg-white shadow-md rounded-lg" />
        </Slider.Root>
        <p aria-label="song duration">{maxDuration}</p>
      </div>
    </div>
  );
};
